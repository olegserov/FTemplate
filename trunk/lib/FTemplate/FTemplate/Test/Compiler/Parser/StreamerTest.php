<?php
class FTemplate_Test_Compiler_Parser_StreamerTest extends PHPUnit_Framework_TestCase
{
    protected function _createStreamer($text)
    {
        return new FTemplate_Compiler_Parser_Streamer($text);
    }
	...
	/**
	 *
	 * @expectedException FTemplate_Compiler_Parser_Streamer_Exception
	 */
